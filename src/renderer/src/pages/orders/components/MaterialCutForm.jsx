...
export default function MaterialCutForm() {
  ...
  return (
    <div>
      <Button variant='contained' color='error' onClick={handleOpen}>Corte de material</Button>
      <Modal
        open={open}
        onClose={handleClose}
      ...
      >
        <Box sx={style}>
          <header className='flex justify-between align-center'>
            <div className='flex items-center '>Corte de Material</div>
